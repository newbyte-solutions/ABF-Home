    ...
    <div class="flex flex-col items-center gap-6 my-6 px-4">
      <div class="flex flex-wrap justify-center gap-4">
        ...
        <div>
          ...
          <select v-model="filters.grade" class="border px-3 py-2 rounded shadow w-40">
        ...
        <div>
          ...
          <select v-model="filters.company" class="border px-3 py-2 rounded shadow w-40 text-black">
            <option value="">Alle</option>
            <option v-for="company in companies" :key="company._id" :value="company.companyName">
              {{ company.companyName }}
            </option>
          </select>
        </div>
