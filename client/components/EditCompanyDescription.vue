<template>
  <div
    class="w-full max-w-4xl mx-auto px-4 md:px-10 flex flex-col md:flex-row items-center justify-center"
  >
...
const updateDescription = async () => {
  try {
    ...
    const { public: publicConfig } = useRuntimeConfig();
    await axios.put(
      `${publicConfig.apiBase}/company/update_description/${props.companyId}`,
      {
