<template>
  ...
  <div class="w-full px-0 md:px-10 flex flex-col items-center">
    ...
    >
      ...
      >
        <div
          class="relative bg-gray-100 rounded-lg shadow-md overflow-hidden max-w-[16rem] h-full max-h-[24rem] flex flex-col"
        >
          <img
          ...
          <div class="p-4 flex flex-col items-center">
            ...
            <span
              class="mt-2 text-sm bg-blue-100 text-blue-800 px-2 py-1 rounded"
            >
