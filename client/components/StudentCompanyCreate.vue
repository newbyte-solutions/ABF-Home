<template>
  <div
    class="w-full min-h-screen bg-gray-900 flex flex-col items-center justify-start py-14 px-4"
  >
    <div class="w-full text-center my-8">
      ...
      <p class="text-lg text-gray-300 mx-auto max-w-4xl mt-4 px-2">
        Her kan du opprette en bedrift som vil vises på nettsiden. Det er viktig
        at du dobbelsjekket all informasjon før du sender inn, da dette vil være
        synlig for alle brukere av systemet. Tullebedrifter eller
        feilinformasjon kan føre til at bedriften blir fjernet fra systemet.
      </p>

      <div class="w-full mt-6 px-4">
        <form
          @submit.prevent="handleNewCompany"
          class="mt-8 max-w-2xl mx-auto bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl shadow-2xl border border-gray-700"
        >
          <h2 class="font-bold text-2xl text-center mb-6 text-white">
