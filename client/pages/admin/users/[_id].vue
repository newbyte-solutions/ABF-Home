  ...
  <div v-if="user" class="w-full min-h-screen mx-auto mt-8 p-6 bg-gray-100">
    <div class="py-20">
      ...
      <form
        ...
        class="max-w-md mx-auto bg-gray-800 p-8 rounded-xl shadow-xl"
      >
        <div class="mb-6">
          ...
          <input
            ...
            type="text"
            class="w-full bg-white text-gray-900 text-lg rounded-lg border-2 border-gray-700 px-4 py-3 focus:outline-none focus:border-blue-500 transition duration-300"
          />
        </div>
        <div class="mb-6">
        ...
        <div class="mb-6">
          <label class="block text-white text-lg mb-3">Phone</label>
          <input
            v-model="user.phone"
            type="tel"
            class="w-full bg-white text-gray-900 text-lg rounded-lg border-2 border-gray-700 px-4 py-3 focus:outline-none focus:border-blue-500 transition duration-300"
        ...
        <div class="mb-6">
          <label class="block text-white text-lg mb-3">Grade</label>
          <select
            v-model="user.grade"
            class="w-full bg-white text-gray-900 text-lg rounded-lg border-2 border-gray-700 px-4 py-3 focus:outline-none focus:border-blue-500 transition duration-300"
          >
        ...
        <div class="mb-8">
          <label class="block text-white text-lg mb-3">Role</label>
          <select
            v-model="user.role"
            class="w-full bg-white text-gray-900 text-lg rounded-lg border-2 border-gray-700 px-4 py-3 focus:outline-none focus:border-blue-500 transition duration-300"
          >
