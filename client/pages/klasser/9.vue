<template>
  <div
    class="w-full mt h-fit py-10 flex justify-center items-center bg-gradient-to-br from-blue-700 to-purple-600 drop-shadow-2xl -z-20"
  >
