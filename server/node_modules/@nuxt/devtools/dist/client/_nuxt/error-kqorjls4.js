import{Q as E,w as x}from"./fm9jupb1.js";import{_ as N}from"./stacktrace-list.vue-gv8cnf42.js";import{k as y,l as m,S as u,a0 as w,$ as C,U as f,a5 as d,W as _,O as S,Q as i,a6 as $}from"./vendor/json-editor-vue-mdfcgt41.js";import"./vendor/unocss-mnpxkox6.js";import"./vendor/shiki-fpe2sz4h.js";import"./filepath-item.vue-dx2h1i9n.js";const O=/(^|@)\S+:\d+/,h=/^\s*at .*(\S+:\d+|\(native\))/m,R=/^(eval@)?(\[native code\])?$/;function F(e,a){if(typeof e.stacktrace<"u"||typeof e["opera#sourceloc"]<"u")return V(e);if(e.stack&&e.stack.match(h))return I(e);if(e.stack)return A(e);throw new Error("Cannot parse given Error object")}function v(e){if(!e.includes(":"))return[e,void 0,void 0];const r=/(.+?)(?::(\d+))?(?::(\d+))?$/.exec(e.replace(/[()]/g,""));return[r[1],r[2]||void 0,r[3]||void 0]}function p(e,a){return e}function I(e,a){return b(e.stack)}function b(e,a){return p(e.split(`
